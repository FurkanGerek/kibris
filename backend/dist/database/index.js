...
const AppDataSource = new typeorm_1.DataSource({
    ...
    synchronize: true,
    logging: false,
    entities: [user_entity_1.default, token_entity_1.default, post_entity_1.default, role_entity_1.default, category_entity_1.default, page_entity_1.default, announcement_entity_1.default],
});
async function seedInitialData() {
    ...
    for (const r of roles) {
        ...
        if (!exists) {
            const role = new role_entity_1.default();
            role.name = r.name;
